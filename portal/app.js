...
const portalObserver = new MutationObserver((records) => {
  ...
  roots.forEach((root) => { hydrateImages(root); enhancePlaylistTrackActions(root); syncMiniRangeFills(root); });
});
