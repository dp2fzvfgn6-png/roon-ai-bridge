...
export class RoonMediaService {
  ...
  async listArtistReleases(
    ...
    const releaseCompleteness: MediaCompleteness = detail.hierarchy === "artists" || (releaseSectionsOpened > 0 && catalogComplete)
      ? "complete"
      : "partial";
